...
exports.PerformanceRecorder = exports.mockPythonError = exports.mockPythonResponse = exports.mockPluginConfig = exports.mockStockConfig = exports.mockStockData = void 0;
/**
 * TypeScript测试全局设置
 */
require("jest");
...
// 模拟Python进程响应
exports.mockPythonResponse = {
    type: 'data',
    data: [exports.mockStockData]
};
// 模拟错误响应
exports.mockPythonError = {
    type: 'error',
    error: 'Network error'
};
// 性能测试辅助
